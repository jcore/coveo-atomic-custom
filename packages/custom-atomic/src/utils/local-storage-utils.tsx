...
export class SafeStorage implements Storage {
  ...
  private tryAccessLocalStorageOrWarn<OnSuccess, OnFailure>(tryTo: () => OnSuccess, orElse: () => OnFailure) {
  ...
  private tryJSONOrWarn<OnSuccess, OnFailure>(key: StorageItems, tryTo: () => OnSuccess, orElse: () => OnFailure) {
    return this.tryOrElse(tryTo, () => {
