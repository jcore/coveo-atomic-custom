...
import { ButtonStyle, getRippleColorForButtonStyle, getClassNameForButtonStyle } from './button-style';
...
export const Button: FunctionalComponent<ButtonProps> = (props, children) => {
  ...
  return (
    <button {...attributes} onMouseDown={e => createRipple(e, { color: rippleColor })}>
