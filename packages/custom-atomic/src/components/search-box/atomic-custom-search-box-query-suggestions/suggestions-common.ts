...
const searchBoxElements = ['atomic-custom-search-box', 'atomic-search-box', 'atomic-insight-search-box'];
 ...
 */
export const dispatchSearchBoxSuggestionsEvent = (event: SearchBoxSuggestionsEvent, element: HTMLElement) => {
